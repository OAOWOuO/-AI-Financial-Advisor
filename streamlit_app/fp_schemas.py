...
class Liabilities:
    ...
    def total(self) -> float:
        return self.mortgage + self.car_loans + self.student_loans + self.credit_cards + self.other
...
class ClientProfile:
    ...
    def gross_monthly_income(self) -> float:
        return (self.gross_annual_income + self.spouse_annual_income + self.other_annual_income) / 12
